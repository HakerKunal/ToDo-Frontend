...
function Task(props) {
    ...
    const [taskObj, setTaskObj] = React.useState({ id: props.item.id, taskname: props.item.taskname, priority: props.item.priority, status: props.item.status, last_modified: props.item.last_modified })
